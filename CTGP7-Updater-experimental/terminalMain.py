...
try:
    _INSTALLER_VERB = {
        ...
        CTGP7Updater._MODE_UPDATE: "update",
        CTGP7Updater._MODE_INTCHECK: "performing integrity checks"
    }
...
Please specify the platform.""")
    ...
    updater = CTGP7Updater(CTGP7Updater._MODE_INSTALL if makeNewInstall else CTGP7Updater._MODE_UPDATE, isInstallForCitra)
...
Do you want to proceed?""".format(_INSTALLER_VERB[updater.operationMode], updater.latestVersion)):
            raise Exception("User cancelled the installation.")
